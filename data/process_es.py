...
if __name__ == '__main__':
    ...
    # evaluate dir：
    evaluate_dir = '../evaluate_es_doc20/'
    ...
    abstract_str_list, all_doc_keywords = data_IO.load_json_data_for_es(file_path_json)
    # abstract_str_list = data_IO.get_abstracts_str(file_path)
    es_results = get_es_results(abstract_str_list, 500)
    ...
    #     all_merged_kp =extract_all_es(es_results, word2vec_model, topN, p)
    #     # print('内外部融合结果：')
